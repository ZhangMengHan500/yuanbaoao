...
const NOVEL_GENRE_GUIDE: Record<string, string> = {
...
const EDU_STAGE_GUIDE: Record<string, string> = {
...
const MARKETING_TYPE_GUIDE: Record<string, string> = {
...
const MARKETING_STYLE_GUIDE: Record<string, string> = {
...
const DOC_CATEGORY_GUIDE: Record<string, string> = {
...
5. 不要输出"# 标题"等Markdown格式标记，直接输出纯文本`;
  ...
  async *streamWrite(topic: string, systemPrompt: string) {
    const messages = [
